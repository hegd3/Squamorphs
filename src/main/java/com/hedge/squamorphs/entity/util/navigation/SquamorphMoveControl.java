...
public class SquamorphMoveControl extends MoveControl {
    ...
    public SquamorphMoveControl(SquamorphEntity entity, int pMaxTurnX, int pMaxTurnY, float pInWaterSpeedModifier) {
        super(entity);
        this.entity = entity;
    ...
    public void tick() {
        ...
        if (this.entity.isInFluidType() || this.entity.isFlying()) {
