...
public class SquamorphBodyAttachmentLayer extends RenderLayer<SquamorphEntity, SquamorphModel> {


    public SquamorphBodyAttachmentLayer(SquamorphRenderer pRenderer) {
    ...
    public void render(PoseStack poseStack, MultiBufferSource buffer, int packedLightIn, SquamorphEntity entity, float v, float v1, float v2, float v3, float v4, float v5) {
        ...
        int index = entity.getBodyType() - 1;
        ...
        if (index >= 0) {
            ...
            renderColoredCutoutModel(getParentModel(), AllTextures.BODY_TEXTURES[index], poseStack, buffer, packedLightIn, entity, r, g, b);
        }
